function I = beerlambertI(par, x, source_type, laserlambda, figson)
% Used for IQE calculations, calculates laser intensity
%% Input arguments
...
%% Output arguments
% I - Intensity of the light as a function of wavelength and position which
% is decayed in penetrating deeper into the sample
%
%% LICENSE
